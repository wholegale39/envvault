...
![License](https://img.shields.io/badge/license-MIT-green) ![Python](https://img.shields.io/badge/python-3.10+-blue) ![CI](https://img.shields.io/github/actions/workflow/status/wholegale39/envvault/ci.yml) ![GitHub stars](https://img.shields.io/github/stars/wholegale39/envvault)

> AES-256-GCM 加密的密钥管理服务。与 OpenAI MCP 协议兼容，Agent 可以安全地请求和取用凭证——全程审计、Agent 不碰明文密钥。

## ✨ 亮点

- 🔐 **加密存储** — AES-256-GCM，密钥永不落明文
- 🤝 **MCP 兼容** — Agent 通过 MCP 协议安全取用
- 📋 **全程审计** — 每次取用都有记录，谁用了密钥一查便知
